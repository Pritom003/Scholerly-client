  ...
  return (
    <header className="w-full top-0 z-50 bg-[#E3E3E5]">
      <div className="w-[80%] mx-auto flex items-center justify-between h-16">
        ...
        {/* Center: Notification and Avatar */}
            ...
            >
              <div className="cursor-pointer">
                <Image
                  ...
                  width={32}
                  height={32}
                  className="rounded-full border-2 w-8 h-8 border-[#815606]"
                />
              </div>
            </Dropdown>
          )}
        ...
        {/* Mobile Dropdown */}
        <div className="md:hidden flex items-center gap-4 space-x-4">
          <NotificationBell />
          {!isLoading && user && (
            <Dropdown
              trigger={['hover']}
